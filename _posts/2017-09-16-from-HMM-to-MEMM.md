...
I'll explain why I need these now, but before that it is useful to know the difference between <b>generative model</b> and <b>discriminative model</b>. You can check this [post]({{ site.baseurl }}/ml/2017/09/15/discriminative-vs-generative-model.html) out.
